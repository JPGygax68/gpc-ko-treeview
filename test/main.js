...
var TreeView = require('../lib/index'); // The TreeView module

// TODO: call a method on each control (class method) that checks whether the ko object is 
// the one that it expects, i.e. the one that has the stringTemplateEngine.
